...
Branches:
* *master* : no direct commit, **only merges** from develop (for each release). For releases, call '_scripts/merge_develop_into_master.sh' to merge *develop* into *master* (and update version and changelog).
