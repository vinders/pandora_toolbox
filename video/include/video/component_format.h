...
#   endif
    ...
    enum class ComponentFormat : int32_t {
      ...
      d24_unorm = 65, ///< GL_DEPTH_COMPONENT24 - DXGI_FORMAT_R24_UNORM_X8_TYPELESS - VK_FORMAT_D24_UNORM
      d16_unorm = 66, ///< GL_DEPTH_COMPONENT16 - DXGI_FORMAT_D16_UNORM - VK_FORMAT_D16_UNORM
      
      d32_f_s8_ui = 67,    ///< GL_DEPTH32F_STENCIL8 - DXGI_FORMAT_D32_FLOAT_S8X24_UINT - VK_FORMAT_D32_SFLOAT_S8_UINT
      d24_unorm_s8_ui = 68,///< GL_DEPTH24_STENCIL8 - DXGI_FORMAT_D24_UNORM_S8_UINT - VK_FORMAT_D24_UNORM_S8_UINT
      s8_ui = 69,          ///< GL_STENCIL_INDEX8 - DXGI_FORMAT_X24_TYPELESS_G8_UINT - VK_FORMAT_S8_UINT

      // block-compression (not supported in OpenGL)
      bc6h_uf = 70, ///< DXGI_FORMAT_BC6H_UF16 - VK_FORMAT_BC6H_UFLOAT_BLOCK
      bc6h_f = 71,  ///< DXGI_FORMAT_BC6H_SF16 - VK_FORMAT_BC6H_SFLOAT_BLOCK
      
      bc7_sRGB  = 72, ///< DXGI_FORMAT_BC7_UNORM_SRGB - VK_FORMAT_BC7_SRGB_BLOCK
      bc7_unorm = 73  ///< DXGI_FORMAT_BC7_UNORM - VK_FORMAT_BC7_UNORM_BLOCK
    };
  }
}
