...
| *video*    | Video rendering (shaders, camera...), video filtering/upscaling, window management/input/events...                   |
...
| Maximum OpenGL4 feature level.<br><sub>*Default: "45" (or "41" on Mac OS)*</sub>             | CWORK_OPENGL4_VERSION      | "46" "45"<br>"43" "41"  | all desktop systems    |
| Enable OpenGLES 3 features.<br><sub>*Default: ON on mobile systems*</sub>                    | CWORK_VIDEO_OPENGLES3      | ON<br>OFF     | all except macOS                 |
| Maximum OpenGLES feature level.<br><sub>*Default: "32"*</sub>                                | CWORK_OPENGLES3_VERSION    | "32" "31"<br>"30"       | all except macOS       |
...
| Maximum Direct3D 11 feature level (11.0 - 11.4).<br><sub>*Default: "111"*</sub>              | CWORK_D3D11_VERSION        | "114" "113"<br>"111" "110"  | only windows systems<br>(MSVC/LLVM required)  |
