...
![Cmake](https://img.shields.io/badge/project-CMake-487.svg)
![C++](https://img.shields.io/badge/language-C++_17-487.svg)
![Gtest](https://img.shields.io/badge/tests-Googletest-487.svg)
![Doxy](https://img.shields.io/badge/docs-Doxygen-487.svg)
...
The code is meant to be highly efficient and easy to use in real-time and video projects : AI, video processing, video games, emulators or embedded systems. Written in modern C++ 17, it supports backwards compatibility with C++ 14.
...
|-----------------------------|------------------------|------------------------|
| Windows 7+ <sub>(x86/x86_64)</sub> | ![vs2019](https://img.shields.io/badge/visual_studio-2019-75b.svg) | [![AppVeyor VS2019](https://ci.appveyor.com/api/projects/status/38j8o8sc55iosqu6/branch/develop?svg=true)](https://ci.appveyor.com/project/vinders/pandora-toolbox/branch/develop) |
|                             | ![vs2017](https://img.shields.io/badge/visual_studio-2017-a99dc2.svg) | [![AppVeyor VS2017](https://ci.appveyor.com/api/projects/status/38j8o8sc55iosqu6/branch/develop?svg=true)](https://ci.appveyor.com/project/vinders/pandora-toolbox/branch/develop) |
|                             | ![mingw7](https://img.shields.io/badge/mingw-gcc_7.1-75b.svg) | [![AppVeyor MinGW](https://ci.appveyor.com/api/projects/status/38j8o8sc55iosqu6/branch/develop?svg=true)](https://ci.appveyor.com/project/vinders/pandora-toolbox/branch/develop) |
| Linux <sub>(x86_64)</sub>          | ![clang9](https://img.shields.io/badge/clang-9.0.0-75b.svg) | [![Build-Linux-clang](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/1)](https://travis-ci.org/vinders/pandora_toolbox) |
|                             | ![gcc9](https://img.shields.io/badge/gcc-9.1-75b.svg) | [![Build-Linux-gcc](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/2)](https://travis-ci.org/vinders/pandora_toolbox) |
|                             | ![gcc7](https://img.shields.io/badge/gcc-7.1-75b.svg) | [![Build-Linux-gcc7](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/3)](https://travis-ci.org/vinders/pandora_toolbox) |
|                             | ![gcc5](https://img.shields.io/badge/gcc-5.1-a99dc2.svg) | [![Build-Linux-gcc5](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/4)](https://travis-ci.org/vinders/pandora_toolbox) |
| Mac OS X <sub>(x86_64)</sub>       | ![clang7](https://img.shields.io/badge/clang-7.0.0-75b.svg) | [![Build-Mac-clang](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/5)](https://travis-ci.org/vinders/pandora_toolbox) |
| iOS 9+ <sub>(arm/arm64)</sub>      | ![clang7](https://img.shields.io/badge/clang-7.0.0-75b.svg) | [![Build-iOS-clang](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/6)](https://travis-ci.org/vinders/pandora_toolbox) |
| Android 8+ <sub>(arm64)</sub>      | ![android64](https://img.shields.io/badge/android-ndk_26-a99dc2.svg) | [![Build-Android64-ndk](https://travis-matrix-badges.herokuapp.com/repos/vinders/pandora_toolbox/branches/develop/7)](https://travis-ci.org/vinders/pandora_toolbox) |
