if(NOT DEFINED _CWORK_OPTIONS_FOUND)
    ...
    if(IOS OR ANDROID)
        set(CWORK_VIDEO_OPENGL4 OFF CACHE INTERNAL "enable OpenGL 4 features" FORCE)
    ...
    if((NOT WIN32 AND NOT WIN64 AND NOT _WIN32 AND NOT _WIN64) OR NOT MSVC)
        set(CWORK_VIDEO_D3D11 OFF CACHE INTERNAL "enable Direct3D 11 features" FORCE)
    ...
    if("$ENV{VULKAN_SDK}" STREQUAL "" AND NOT ANDROID)
        set(CWORK_VIDEO_VULKAN OFF CACHE INTERNAL "enable Vulkan features" FORCE)
        ...
        if(NOT DEFINED CWORK_VULKAN_VERSION)
            set(CWORK_VULKAN_VERSION "12" CACHE STRING "maximum Vulkan revision support")
            set_property(CACHE CWORK_VULKAN_VERSION PROPERTY STRINGS "12") # possible values for GUI
        endif()
    endif()
