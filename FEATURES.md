...
| *system/api/android_app.h*       | Android app state container                 | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![OK](_img/badges/feat_done.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png)
| *system/api/windows_app.h*       | Windows app instance container              | ![OK](_img/badges/feat_done.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png)
| *system/api/windows_api.h*       | Windows API, with version + options         | ![OK](_img/badges/feat_done.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png)
| *system/api/windows_base_types.h*| Minimum Windows API: types defs only        | ![OK](_img/badges/feat_done.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png) | ![NA](_img/badges/feat_not_appl.png)
